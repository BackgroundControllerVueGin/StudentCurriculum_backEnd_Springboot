package com.example.StudentCurriculum_backEnd_Springboot.common;
...
public class TokenCommon {
     ...
     * 密钥
     */
    private static final String SECRET = "401_is_Best";
    ...
    public static Integer getUserIdFormToken(String token) {
